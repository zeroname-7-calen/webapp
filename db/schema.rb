...
ActiveRecord::Schema.define(version: 2020_09_21_111628) do
  ...
  create_table "eventsguides", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title", null: false
    t.text "content"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "created_at"], name: "index_eventsguides_on_user_id_and_created_at"
    t.index ["user_id"], name: "index_eventsguides_on_user_id"
  end
  ...
  add_foreign_key "eventsguides", "users"
